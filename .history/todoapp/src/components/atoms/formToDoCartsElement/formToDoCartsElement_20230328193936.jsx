  ...
  return (
    <li className="formToDo__CartsElement" key={id}>
      ...
      <div className="formToDo__RowButtons">
        <Button className="rowButton" variant="contained" color="primary" startIcon={<SendIcon/>}>Update</Button>
        <Button className="rowButton" variant="contained" color="success">Ready</Button>
        <Button className="rowButton" variant="outlined" color="error">Delete</Button>
      </div>
    </li>
  );
};
