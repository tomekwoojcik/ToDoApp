...
const FormToDoCartsElement = (arrayElement) => {
  ...
  return (
    <li className="formToDo__CartsElement" key={id}>
      {!update ? title : <div className="formToDo__UpdateRow"><input className="updateInput" type="text"/><CancelIcon className="cancelButton" /> <CheckIcon className="checkButton"/></div>}
