...
const FormToDoCartsElement = (arrayElement) => {
  ...
  return (
    <li className="formToDo__CartsElement" key={id}>
      {!update ? title : <div><input type="text"/><Button className="rowButton" variant="contained" color="error" endIcon={<CancelIcon className="buttonIcons" style={{fontSize:"small"}} />} /></div>}
