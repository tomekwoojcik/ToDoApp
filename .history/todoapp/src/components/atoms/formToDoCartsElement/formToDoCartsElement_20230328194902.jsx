  ...
  return (
    <li className="formToDo__CartsElement" key={id}>
      ...
      <div className="formToDo__RowButtons">
        ...
        <Button className="rowButton" variant="contained" color="success" endIcon={<SendIcon style={{fontSize:"small"}}/>}>Ready</Button>
        <Button className="rowButton" variant="outlined" color="error" endIcon={<DeleteIcon style={{fontSize:"small"}}/>}>Delete</Button>
      </div>
    </li>
  );
};
