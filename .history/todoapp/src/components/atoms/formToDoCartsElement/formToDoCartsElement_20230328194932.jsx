  ...
  return (
    <li className="formToDo__CartsElement" key={id}>
      ...
      <div className="formToDo__RowButtons">
        <Button className="rowButton" variant="contained" color="primary" endIcon={<UpgradeIcon style={{ fontSize: "small", marginRight:"2px"}}/>}>Update</Button>
        <Button className="rowButton" variant="contained" color="success" endIcon={<SendIcon style={{fontSize:"small", marginRight:"2px"}}/>}>Ready</Button>
        <Button className="rowButton" variant="outlined" color="error" endIcon={<DeleteIcon style={{fontSize:"small", marginRight:"2px"}}/>}>Delete</Button>
      </div>
    </li>
  );
};
