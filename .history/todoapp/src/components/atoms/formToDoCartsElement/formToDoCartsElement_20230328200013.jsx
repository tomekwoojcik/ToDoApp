  ...
  return (
    <li className="formToDo__CartsElement" key={id}>
      ...
      <div className="formToDo__RowButtons">
        <Button className="rowButton" variant="contained" color="primary" endIcon={<UpgradeIcon className="buttonIcons"/>}>Update</Button>
        <Button className="rowButton" variant="contained" color="success" endIcon={<SendIcon className="buttonIcons"/>}>Ready</Button>
        <Button className="rowButton" variant="outlined" color="error" endIcon={<DeleteIcon className="buttonIcons" />}>Delete</Button>
      </div>
    </li>
  );
};
