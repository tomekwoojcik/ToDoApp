...
const FormToDoCartsElement = (arrayElement) => {
  ...
  return (
    <li className="formToDo__CartsElement" key={id}>
      {!update ? title : <div className="formToDo__UpdateCard"><input className="updateInput" type="text"/><div className="buttonsRow"><CancelIcon className="cancelButton buttonUpdate" /> <CheckIcon className="checkButton buttonUpdate"/></div></div>}
