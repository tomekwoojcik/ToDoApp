...
const FormToDoCartsElement = (arrayElement) => {
  ...
  const buttonArr = [
    { name: "Update", function: buttonFunction(id), variant: "contained", color: "primary", icon: <UpgradeIcon className="buttonIcon" style={{ fontSize: "small" }} /> },
    { name: "Update", function: buttonFunction(id), variant: "contained", color: "primary", icon: <UpgradeIcon className="buttonIcon" style={{ fontSize: "small" }} /> },
    { name: "Update", function: buttonFunction(id), variant: "contained", color: "primary", icon: <UpgradeIcon className="buttonIcon" style={{ fontSize: "small" }} /> }]
  return (
    <li className="formToDo__CartsElement" key={id}>
      ...
      <div className="formToDo__RowButtons">
        {buttonArr.map((el)=>{<Button onClick={e => buttonFunction(id)} className="rowButton" variant="contained" color="primary" endIcon={<UpgradeIcon className="buttonIcon" style={{ fontSize: "small" }} />}>Update</Button>})}
