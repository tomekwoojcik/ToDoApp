...
export const FormProvider = ({ children }) => {
  ...
  const deleteData = (id, localStorageName, arr) => {
    const data = arr.filter(el => el.id !== id);
    sentValue(data, localStorageName);
  }
  ...
  const handleUpdate = () => {
    ...
    deleteData(newData.id, "toDoElements", newData);
    newData.push(data);
  ...
  const handleReady = (e, id, name) => {
    ...
    deleteData(id, "toDoElements", updateData);
    setCheckToDoElementsData(itemsLocalStorage);
  }
