...
export const FormProvider = ({ children }) => {
  ...
  const iconArr = [
    {
      icon: <InstagramIcon className="formToDo__footerIcon" />,
      key: 1
    },
    {
      icon: <FacebookIcon className="formToDo__footerIcon" />,
      key: 2
    },
    {
      icon: <LinkedInIcon className="formToDo__footerIcon" />,
      key: 3
    },
    {
      icon: < TwitterIcon className="formToDo__footerIcon" />,
      key: 4
    }
