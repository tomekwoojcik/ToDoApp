...
export const FormProvider = ({ children }) => {
  ...
  const iconArr = [
    <Button><InstagramIcon style={{ width: "10px", height: "10px" }} /></Button>,
    <Button><FacebookIcon style={{ width: "10px", height: "10px" }} /></Button>,
    <Button><LinkedInIcon style={{ width: "10px", height: "10px" }} /></Button>,
    <Button><TwitterIcon style={{ width: "10px", height: "10px" }} /></Button>
  ];
