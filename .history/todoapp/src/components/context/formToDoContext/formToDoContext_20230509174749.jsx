...
export const FormProvider = ({ children }) => {
  ...
  const iconArr = [<InstagramIcon style={{width:"10px", height:"10px"}}/>, <FacebookIcon style={{width:"10px", height:"10px"}}/>, <LinkedInIcon style={{width:"10px", height:"10px"}}/>, <TwitterIcon style={{width:"10px", height:"10px"}}/>];
