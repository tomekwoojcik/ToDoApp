...
export const FormProvider = ({ children }) => {
  ...
  const iconArr = [
    <Button variant="contained"><InstagramIcon style={{ width: "10px", height: "10px" }} /></Button>,
    <Button variant="contained"><FacebookIcon style={{ width: "10px", height: "10px" }} /></Button>,
    <Button variant="contained"><LinkedInIcon style={{ width: "10px", height: "10px" }} /></Button>,
    <Button variant="contained"><TwitterIcon style={{ width: "10px", height: "10px" }} /></Button>
  ];
