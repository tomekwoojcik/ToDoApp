...
export const FormProvider = ({ children }) => {
  ...
  const sentValueToLocalStorage = (localStorageDataName, value) = localStorage.setItem(`${localStorageDataName}`, JSON.stringify(value));
  ...
  const sentData = () => {
    ...
    if ( getData("toDoElements") === null) {
      const newArr = [];
      sentValueToLocalStorage("toDoElements", newArr);
    }
