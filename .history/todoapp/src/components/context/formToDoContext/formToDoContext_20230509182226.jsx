...
export const FormProvider = ({ children }) => {
  ...
  const iconArr = [
    {
      icon: <InstagramIcon style={{ width: "10px", height: "10px" }} />,
      key: 1
    },
    {
      icon: <FacebookIcon style={{ width: "10px", height: "10px" }} />,
      key: 2
    },
    {
      icon: <LinkedInIcon style={{ width: "10px", height: "10px" }} />,
      key: 3
    },
    {
      icon: < TwitterIcon style={{ width: "10px", height: "10px" }} />,
      key: 4
    }
