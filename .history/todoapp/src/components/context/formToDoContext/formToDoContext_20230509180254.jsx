...
export const FormProvider = ({ children }) => {
  ...
  const iconArr = [
    <Button className="formToDo__footer" variant="contained" key={1}><InstagramIcon style={{ width: "10px", height: "10px" }} /></Button>,
    <Button variant="contained" key={2}><FacebookIcon style={{ width: "10px", height: "10px" }} /></Button>,
    <Button variant="contained" key={3}><LinkedInIcon style={{ width: "10px", height: "10px" }} /></Button>,
    <Button variant="contained" key={4}><TwitterIcon style={{ width: "10px", height: "10px" }} /></Button>
  ];
